...
This is not yet a playable-speed build. The latest controlled same-executable comparison over 128 gameplay frames measured **3.47 FPS with native VU blocks versus 3.40 FPS interpreted**, about a 2.2% improvement. An earlier candidate measured a larger 12.1% difference, so these sequential shared-machine samples are not a sustained-speed guarantee. Existing black-prop, missing-foliage, HUD, and effect defects remain. Broader timing identifies vector processing as the main remaining cost. A small operand-preparation optimization is submitted as [PS2Recomp PR #247](https://github.com/ran-j/PS2Recomp/pull/247), with 427/427 upstream-based tests. Removing duplicate cycle work, improving packet copying, and replacing full integer-register scans with existing masks is submitted as [PS2Recomp PR #248](https://github.com/ran-j/PS2Recomp/pull/248), with 427/427 upstream-based tests. The current native-block bring-up passes all 122 VU-related tests; this is not a full-suite pass.
