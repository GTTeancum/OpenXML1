...
This is not yet a playable-speed build: the latest ordinary run measured about 3.12 FPS over 128 gameplay frames, without performance profilers enabled. That is better than the earlier 2.75 FPS sample, but it is not a controlled sustained-speed guarantee. Broader timing identifies vector processing as the main remaining cost. A small operand-preparation optimization is submitted as [PS2Recomp PR #247](https://github.com/ran-j/PS2Recomp/pull/247), with 427/427 upstream-based tests. Removing duplicate cycle work and improving packet copying is submitted as [PS2Recomp PR #248](https://github.com/ran-j/PS2Recomp/pull/248), with 426/426 upstream-based tests and 97/97 local vector tests passing.
